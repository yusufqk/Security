...
"""
from windows_discovery import Rocket
import nmap
import sys
import optparse
import urllib2
...
class StormTrooper(object):
    ...
    #This function performs ping sweep to detect live systems
    ...
    #This function executes version scan on live systems
    ...
    #This function finds machines with a web service
    #Sends get request to determine this
    ...
    #Looks for machine with ports 139 & 445 open
