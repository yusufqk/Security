...
This script parses a tcpdump file for a specific IP address.
It will pinpoint the top 5 machines communicated with and 
pinpoint geolocations.

There is some redundancies in this code. In the future
the code will be more succinct.
...
class MrMeeSeeks(object):
    ...
    #Parses each line in tcpdump file
    ...
    #processes details from each line
