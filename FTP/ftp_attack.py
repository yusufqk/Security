...
class Darkness(object):
    ...
    #This function verifies if anonymous login is allowed
    ...
    #Using default credentials that the mirai botnet found useful, this
    #function will attempt brute-forcing the password
